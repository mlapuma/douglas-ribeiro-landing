...
O site já possui rastreamento invisível preparado para Google Analytics 4.
...
Enquanto `GA_MEASUREMENT_ID` estiver vazio, nenhum dado é enviado para o Google Analytics.
